...
struct State {
    ...
    int score;
    bool isMax;                // true = X's turn (computer), false = O's turn (human)
...
void play_game(State* root) {
    ...
    while (true) {
        ...
        newBoard[x][y] = 'O';
        State* nextState = new State{current, newBoard, 0, true, {}};
